package com.myjava.msscbeerclient.web.config;
...
public class BlokingRestTemplateCustomizer implements RestTemplateCustomizer {
	...
	public BlokingRestTemplateCustomizer(@Value("${sfg.maxtotalconnections}")Integer maxTotalConnections,
			@Value("${sfg.defaultmaxtotalconnections}")Integer defaultMaxTotalConnections,
			@Value("${sfg.connetionrequesttimeout}")Integer connectionRequestTimeOut,
			@Value("${sfg.scokettimeout}")Integer socketTimeOut) {
